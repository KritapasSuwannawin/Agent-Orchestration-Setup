...
Agents are available at `.cursor/agents/`. Use kebab-case ids as the canonical identifiers in docs, handoffs, and `@...` mentions. Display names remain human-readable labels only.
