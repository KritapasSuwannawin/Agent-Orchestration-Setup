...
- The task-scoped artifact folder under `.cursor/docs/{feature}/{task}/artifacts/`
...
- Each task must have a definition of done (reference `.cursor/skills/definition-of-done/SKILL.md`).
