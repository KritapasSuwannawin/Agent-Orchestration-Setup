...
Write a file named `tasks.md` to `.cursor/docs/{feature}/tasks.md` (where `{feature}` is the kebab-case slug of the user's original request) with the structure defined by `.cursor/skills/task-breakdown/SKILL.md`.
