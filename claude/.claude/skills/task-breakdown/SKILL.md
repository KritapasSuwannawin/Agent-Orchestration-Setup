...
- The task-scoped artifact folder under `.claude/docs/{feature}/{task}/artifacts/`
...
- Each task must have a definition of done (reference `.claude/skills/definition-of-done/SKILL.md`).
