...
Always read `.github/skills/coding-standards/SKILL.md` before implementation. Then load the skills that match the task:

- Frontend work: `.github/skills/frontend-patterns/SKILL.md`, `.github/skills/feature-sliced-design/SKILL.md`
- Redux or async state work: `.github/skills/state-management/SKILL.md`
- Component or token changes: `.github/skills/design-system/SKILL.md`
- User-facing UI or accessibility changes: `.github/skills/accessibility/SKILL.md`
- Backend work: `.github/skills/backend-patterns/SKILL.md`, `.github/skills/clean-architecture/SKILL.md`
- API or contract changes: `.github/skills/api-design/SKILL.md`
- Persistence, schema, or index changes: `.github/skills/database-design/SKILL.md`
- Migrations: `.github/skills/migration/SKILL.md`
- Unit tests: `.github/skills/unit-testing/SKILL.md`
- Backend integration coverage: `.github/skills/integration-testing/SKILL.md`
- Frontend E2E coverage: `.github/skills/e2e-testing/SKILL.md`
...
- Store task-scoped artifacts under `.github/docs/{feature}/{task}/artifacts/` and cite them in `dev-summary.md`.

### 6. Self-Review Before QA

Before handing off, read `.github/skills/code-review/SKILL.md` and review your own changes against architecture, contracts, security, tests, and evidence requirements.
...
Write a file named `dev-summary.md` to `.github/docs/{feature}/{task}/dev-summary.md` with the following sections:
